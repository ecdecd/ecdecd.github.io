$(function(){
    ...
    var imageList = $("#actors.kido .mainContent .image li");
    var imageSwitchBtn = $("#actors .mainContent .ver ul li a");
    ...
    imageSwitchBtn.click(function(){
        ...
        $("#actors.kido .mainContent .image li.current").find("img").gritch(_gritchParam);
        return false;
    });
